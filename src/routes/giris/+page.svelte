...
<div class="flex min-h-screen">
    ...
    <div class="mx-auto w-full max-w-sm lg:w-96">
      <div>
        ...
        <p class="mt-2 text-sm">
          ...
          <a href="/kayit-ol" class="font-medium text-primary-400 hover:text-zinc-50"
            >Hemen Kayıt Olun</a
          >
        </p>
      </div>
  ...
  <div class="hidden flex-1 sm:block bg-center bg-cover min-h-full" style="background-image: url('https://cdn.dribbble.com/users/1484654/screenshots/12018680/media/bb5fc75f66bcc4601d3cd5c5b372366f.jpg?compress=1&resize=1600x1200&vertical=center');">
...
<style lang="postcss">
  ...
  .label {
    @apply block text-sm font-medium text-zinc-50 opacity-70;
  }
